      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-gray-900">ShrinkIt Pro</span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed">
              Simplify your links, track your audience, and grow your brand with our powerful URL shortening platform.
            </p>
          </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} ShrinkIt Pro. All rights reserved.
          </p>
